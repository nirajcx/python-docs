...
| **Databases & System Design**| [04-database-system-design-questions.md](./questions-bank/04-database-system-design-questions.md) | Composite index leftmost prefix, isolation levels (ACID), UUIDv7 B-tree locality, multi-tenancy SaaS models, cache stampede locks, RAG latency budgets. |
